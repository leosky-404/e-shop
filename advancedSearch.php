                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <select class="form-select" id="c1">
                                            ...
                                            <?php $category_rs = Database::search("SELECT * FROM `category`");
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <select class="form-select" id="m">
                                            ...
                                            <?php $model_rs = Database::search("SELECT * FROM `model`");
                                    ...
                                    <div class="col-12 col-lg-6 mb-3">
                                        <select class="form-select" id="c2">
                                            ...
                                            <?php $condition_rs = Database::search("SELECT * FROM `condition`");
                                    ...
                                    <div class="col-12 col-lg-6 mb-3">
                                        <select class="form-select" id="c3">
                                            ...
                                            <?php $color_rs = Database::search("SELECT * FROM `color`");
